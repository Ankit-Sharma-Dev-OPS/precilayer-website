        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Precision tooling and EDM-machined components for demanding manufacturing applications
            </p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 30 }}
          ...
          >
            <div className="aspect-[4/3] bg-space-900/50 flex items-center justify-center p-8 overflow-hidden">
              <img src={edmToolingImg} alt="Wire EDM Tool Steel Components" className="w-full h-full object-contain group-hover:scale-105 transition-transform duration-500" style={{ imageRendering: '-webkit-optimize-contrast', filter: 'contrast(1.1) brightness(1.05)' }} />
            </div>
            <div className="p-6 text-center">
              <h3 className="font-bold text-xl text-white mb-2">EDM & Precision Tooling Components</h3>
              <p className="text-gray-400">Hardened tool steel die inserts, precision mold cavities, and intricate profile-cut parts with fine EDM surface finish</p>
            </div>
          </motion.div>
        </div>
      </section>
