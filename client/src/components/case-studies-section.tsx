          ...
          {caseStudies.map((study, index) => {
            ...
            return (
              <motion.div 
                ...
                viewport={{ once: true }}
                className="bg-space-800 p-8 rounded-xl border border-gray-700 hover:border-cyber-400 transition-all scroll-reveal hover-scale gentle-glow shadow-lg shadow-cyan-500/10 hover:shadow-cyan-400/60 hover:shadow-2xl"
