          ...
          {caseStudies.map((study, index) => {
            ...
            return (
              <motion.div 
                ...
                viewport={{ once: true }}
                className="bg-space-700/95 p-8 rounded-xl border border-gray-700 hover:border-cyber-400 transition-all scroll-reveal hover-scale shadow-2xl shadow-cyan-500/30 hover:shadow-cyan-400/80 hover:shadow-[0_0_50px_theme(colors.cyan.400)] hover:border-2"
